"""
Django settings for steep_unit_dev_63080 project.
...
ROOT_URLCONF = 'steep_unit_dev_63080.urls'
...
WSGI_APPLICATION = 'steep_unit_dev_63080.wsgi.application'
...
SPECTACULAR_SETTINGS = {
    ...
    "TITLE": "steep_unit_dev_63080 API",
    "DESCRIPTION": "API documentation for steep_unit_dev_63080 App",
    "VERSION": "v1",
}
